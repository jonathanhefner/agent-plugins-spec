...
The optional `displayName` field provides a human-readable plugin name for presentation. A client that presents a human-readable plugin name SHOULD use `displayName` when present and `name` otherwise.
